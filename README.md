...
1. [Chapter I - Алгоритмы](#chapter-i) \
    3.1. [Part 1 - Обход графа в глубину и в ширину](#part-1-обход-графа-в-глубину-и-в-ширину)  
...
* Код библиотеки находиться в текущей ветке 
...
* Необходимо использовать *самописные* вспомогательные классы `Stack` и `Queue` (для этого можно переиспользовать своё решение из проекта *CPP2*). Эти классы должны содержать в себе следующие методы:
